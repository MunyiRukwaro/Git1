...
public class SellOthers extends javax.swing.JDialog {
     ...
     */
    public SellOthers(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
String sql = "SELECT ID,Name,Price from stock WHERE Category='Others' && Quantity>1";
...
this.dispose();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SellOthers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
