...
public class SellClothing extends javax.swing.JDialog {
     ...
     */
    public SellClothing(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        PopulateClothTable();
    }
public void PopulateClothTable(){
jPanel2.removeAll();
...
String sql = "SELECT ID,Name,Price from stock WHERE Category='Clothing' && Quantity>1";
...
else if(i==2){columnNames.addElement("Clothing" );}
...
stable.addMouseListener(new MouseAdapter()   
   ...
   ClothName=String.valueOf(stable.getModel().getValueAt(row, 1));
...
try { 
         ...
         statement.setString(2,ClothName);
         ...
         int k;
            k=JOptionPane.showConfirmDialog(jPanel2,""+quantity+" "+ClothName+" sold! Do you wish to make another Sale?","Sale Success",JOptionPane.YES_NO_OPTION);
...
this.dispose();        // TODO add your handling code here:
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        int choice;
            choice=JOptionPane.showConfirmDialog(jPanel2,""+ClothName+" will be  sold! Are you sure you want to make the sale?","Order Confirmation",JOptionPane.YES_NO_OPTION);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SellClothing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
